...
function VendorDependency() {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Vendor Dependency Page | TRST</title>
      ...
      <div className="page-content">
        <div className="main-content1">
          <div className="d-flex align-items-center justify-content-between">
            <div className="header-text">Vendor Dependency</div>
            <div
        ...
        <div className="main-content2 pt-3">
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center">
              <span className="header-title">Vendor Dependency</span>
              ...
              <span className="dropdown">
                ...
                >
                  ...
                  <li class="dropdown-checkbox">
                    <label>
                      <input type="checkbox" className="ms-2 me-1" />
                      If yes what the committed Recovery Time
                    </label>
                  </li>
                  <li class="dropdown-checkbox">
                    <label>
            ...
            <div>
              <NavLink className="button1 border-1" to="/new-vendor-dependency">
...
export default VendorDependency;
