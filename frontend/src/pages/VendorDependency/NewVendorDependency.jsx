...
function NewVendorDependency() {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>New Vendor Dependency Page | TRST</title>
      ...
      <div className="page-content">
        <div className="main-content1">
          <div className="d-flex align-items-center justify-content-between">
            <div className="header-text">
              Vendor Dependency: New Vendor Dependency{" "}
            </div>
        ...
        <div className="form-content">
          <div className="form-heading">Vendor Dependency Information</div>
          <div className="border-1"></div>
          <Form>
            <div className="row pt-4">
              <div className="col-8">
                {["Vendor Dependency"].map((label, index) => (
                ...
                {["Types of services rendered"].map((label, index) => (
                  <div className="mb-3 d-flex align-items-center" key={index}>
                    <Label
                      htmlFor={label}
                      className="form-label me-2 fs-15 w-40"
                ...
                <div className="mb-3 d-flex align-items-center">
                  <Label
                    ...
                    className="form-label me-2 fs-15 w-40"
                  >
                    Impact if the organisation stops service
                  </Label>
                  <div className="dropdown-container position-relative flex-grow-1 w-100">
                    <button
                ...
                <div className="mb-3 d-flex align-items-center">
                  <Label htmlFor="rto" className="form-label me-2 fs-15 w-40">
                    Does your SLA demands service continuity
                  </Label>
                  <div className="dropdown-container position-relative flex-grow-1 w-100">
                    <button
                ...
                <div className="mb-3 d-flex align-items-center">
                  <Label htmlFor="rpo" className="form-label me-2 fs-15 w-40">
                    Does the vendor has BCM implemented?
                  </Label>
                  <div className="dropdown-container position-relative flex-grow-1 w-100">
                    <button
                ...
                {["If yes what the committed Recovery Time"].map(
                  (label, index) => (
                    <div className="mb-3 d-flex align-items-center" key={index}>
                      <Label
                        htmlFor={label}
                ...
                <div className="mb-3 d-flex align-items-center">
                  <Label
                    ...
                    className="form-label me-2 fs-15 w-40"
                  >
                    Vendor BCM Plan has been tested
                  </Label>
                  <div className="dropdown-container position-relative flex-grow-1 w-100">
                    <button
...
export default NewVendorDependency;
