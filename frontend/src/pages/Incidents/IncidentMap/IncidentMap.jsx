...
function IncidentMap() {  const [isOpen, setIsOpen] = useState(false);
  ...
  return (
    <React.Fragment>
    <Helmet>
      <title>Incident Map Page| TRST</title>
    ...
    <div className="page-content">
      <div className="main-content1">
        <div className="d-flex align-items-center justify-content-between">
          <div className="header-text">Incident Map</div>
          <div
      ...
      <div className="main-content2 pt-3">
        <div className="d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center">
            <span className="header-title">Incident Map</span>
          ...
          <div>
            <NavLink className="button1 border-1" to="/new-incident-map">
