  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        ...
        <div className="form-content">
          ...
          <Form>
            <div className="row pt-4">
              <div className="col-6">
                {[" Application Name"].map((label, index) => (
                ...
                {["Application ID", "Application Alias", "Application URL"].map(
                  (label, index) => (
                    <div className="mb-3 d-flex align-items-center" key={index}>
                      <Label
                        htmlFor={label}
        ...
        <div className="form-content">
          <div className="form-heading">Locations
          </div>
          <div className="border-1"></div>
          <Form>
            <div className="row pt-4">
              <div className="col-6">
                <div className="mb-3 d-flex">
                  <label
                    htmlFor="editors"
                    className="form-label fs-15 w-40 me-2"
                  >
                    Primary Data Center
                  </label>
                  <div
