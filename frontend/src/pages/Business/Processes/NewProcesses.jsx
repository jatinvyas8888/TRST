    ...
    <React.Fragment>
      ...
      <div className="page-content">
        ...
        <div className="form-content">
          ...
          <div className="border-1"></div>
          <h5 className="mt-3">
            The following form will help to assess and determine Processes
            critical to the Organization in the event of a disruption. Separate
            tabs evaluate the various factors to determine the criticality of
            each Process. Entering the data on this form will update the
            associated BIAs and Plans.
          </h5>
          <Form>
            <div className="row pt-4">
              <div className="col-8">
                ...
                {["Outline the activity steps"].map((label, index) => (
                  <div className="mb-3 d-flex align-items-center" key={index}>
                    <Label
                      htmlFor={label}
                      className="form-label me-2 fs-15 w-40"
                ...
                <div className="mb-3 d-flex">
                  <label
                    ...
                    className="form-label fs-15 w-20 me-2"
                  >
                    Process Editor <span class="text-danger">*</span>
                  </label>
                  <div
                    className="form-control1 d-flex flex-wrap gap-2"
                    style={{
                ...
                <div className="mb-3 d-flex align-items-center">
                  ...
                  >
                    RTO <FaQuestionCircle className="fs-15" />
                  </Label>
