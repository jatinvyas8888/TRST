...
function Processes() { const [isOpen, setIsOpen] = useState(false);
...
<React.Fragment>
      <Helmet>
        <title>Processes Page | TRST</title>
      ...
      <div className="page-content">
        <div className="main-content1">
          <div className="d-flex align-items-center justify-content-between">
            <div className="header-text">Processes</div>
            <div
        ...
        <div className="main-content2 pt-3">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div>
              <NavLink className="button1 border-1" to="/new-business-processes">
