                                                                                                            ...
                                                                                                            <React.Fragment key={key}>
                                                                                                                {!subSubChildItem.isChildItem ? (
                                                                                                                    ...
                                                                                                                    <li className="nav-item">
                                                                                                                        ...
                                                                                                                        <Collapse className="menu-dropdown" isOpen={subSubChildItem.stateVariables} id="sidebarVendors">
                                                                                                                            <ul className="nav nav-sm flex-column">
                                                                                                                                {subSubChildItem.childItems && (
                                                                                                                                    (subSubChildItem.childItems || []).map((vendorItem, key) => (
                                                                                                                                        <li className="nav-item" key={key}>
                                                                                                                                            <Link
                                                                                                                                                to={vendorItem.link ? vendorItem.link : "/#"}
                                                                                                                                                className="nav-link"
                                                                                                                                            >
                                                                                                                                                {props.t(vendorItem.label)}
                                                                                                                                            </Link>
                                                                                                                                        </li>
                                                                                                                                    ))
                                                                                                                                )}
